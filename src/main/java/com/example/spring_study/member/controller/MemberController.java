package com.example.spring_study.member.controller;
...
import com.example.spring_study.member.service.MemberService;
...
public class MemberController {
	...
	public ModelAndView mofidyForm(HttpServletRequest request) {
